...
program
    ...
    .description('Generates React Components in specified folder (default: Current Directory) with customization options')
    ...
    .option('-s, --stateless', 'Generates the stateless functional component. (Default is ES6 class)')
    .option('-d, --dir', 'Creates a [component name] directory with component file inside')
    .option('-f, --full', 'Generate folder with a .js file for functional part, a .jsx file with stateless functional component as template, and a style file')
